...
WriteToSerialArray<T>::WriteToSerialArray(T *array_, plint typedSize_) :
    array((char *)(array_)), typedSize(typedSize_), pos(0)
{ }
...
template <typename T>
void WriteToSerialArray<T>::writeHeader(pluint)
{ }

template <typename T>
void WriteToSerialArray<T>::writeData(char const *dataBuffer, pluint bufferSize)
{
...
ReadFromSerialArray<T>::ReadFromSerialArray(T const *array_, plint typedSize_) :
    array((char const *)(array_)), typedSize(typedSize_), pos(0)
{ }
...
template <typename T>
void ReadFromSerialArray<T>::readHeader(pluint) const
{ }
