...
public:
    SpecificMultiBlockGenerator2D(MultiBlockGenT multiBlockGen_) : multiBlockGen(multiBlockGen_) { }
...
public:
    ...
    int announce(
        ...
        MultiBlockGenerator2D *generator);
...
public:
    ...
    MultiBlockRegistration2D() : numRegistered(0) { }

private:
    MultiBlockRegistration2D(MultiBlockRegistration2D const &rhs) : numRegistered(rhs.numRegistered)
    { }
