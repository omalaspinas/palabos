...
void NLD_VelocityBoundaryDynamics3D<T, Descriptor>::defineVelocity(
    Cell<T, Descriptor> &, Array<T, Descriptor<T>::d> const &velocity_)
{
    u = velocity_;
}
...
void NLD_VelocityBoundaryDynamics3D<T, Descriptor>::computeVelocity(
    Cell<T, Descriptor> const &, Array<T, Descriptor<T>::d> &velocity_) const
{
    velocity_ = u;
}
...
template <typename T, template <typename U> class Descriptor>
void NLD_VelocityBoundaryDynamics3D<T, Descriptor>::prepareCollision(Cell<T, Descriptor> &)
{ }
...
template <typename T, template <typename U> class Descriptor>
void NLD_VelocityNeumannBoundaryDynamics3D<T, Descriptor>::prepareCollision(Cell<T, Descriptor> &)
{ }
...
template <typename T, template <typename U> class Descriptor>
void NLD_OutflowBoundaryDynamics3D<T, Descriptor>::prepareCollision(Cell<T, Descriptor> &)
{ }
...
template <typename T, template <typename U> class Descriptor>
void NLD_AD_DirichletDynamics3D<T, Descriptor>::defineDensity(Cell<T, Descriptor> &, T density)
{
    rho = density;
}

template <typename T, template <typename U> class Descriptor>
T NLD_AD_DirichletDynamics3D<T, Descriptor>::computeDensity(Cell<T, Descriptor> const &) const
{
    return rho;
}
...
template <typename T, template <typename U> class Descriptor>
void NLD_AD_DirichletDynamics3D<T, Descriptor>::prepareCollision(Cell<T, Descriptor> &)
{ }
...
void NLD_AD_DirichletDynamics3D<T, Descriptor>::planeComputeMacroscopic(
    int, int, plint iX, plint iY, plint iZ, BlockLattice3D<T, Descriptor> &lattice, T &rhoBar,
    Array<T, 3> &j, T &thetaBar)
{
...
void NLD_AD_DirichletDynamics3D<T, Descriptor>::edgeComputeMacroscopic(
    int, int, int, plint iX, plint iY, plint iZ, BlockLattice3D<T, Descriptor> &lattice, T &rhoBar,
    Array<T, 3> &j, T &thetaBar)
{
    rhoBar = Descriptor<T>::rhoBar(rho);
    // Here we decide to return j^eq instead of j.
...
template <typename T, template <typename U> class Descriptor>
void NLD_AD_NeumannBoundaryDynamics3D<T, Descriptor>::prepareCollision(Cell<T, Descriptor> &)
{ }
