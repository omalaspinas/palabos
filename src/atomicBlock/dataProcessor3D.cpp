...
void DataProcessorGenerator3D::rescale(
 ...
 */
void DataProcessorGenerator3D::setscale(
...
void DataProcessorGenerator3D::serialize(
    [[maybe_unused]] Box3D &domain, [[maybe_unused]] std::string &data) const
{ }
...
void BoxedDataProcessorGenerator3D::serialize(
    Box3D &domain_, [[maybe_unused]] std::string &data) const
{
    domain_ = domain;
}
...
void MultiBoxedDataProcessorGenerator3D::serialize(
    [[maybe_unused]] Box3D &domain_, [[maybe_unused]] std::string &data) const
{ }
 ...
 *  \param dtScale Scale factor for time scale dt.
 */
void ReductiveDataProcessorGenerator3D::rescale(
...
void ReductiveDataProcessorGenerator3D::serialize(
    [[maybe_unused]] Box3D &domain, [[maybe_unused]] std::string &data) const
{ }
...
void BoxedReductiveDataProcessorGenerator3D::serialize(
    Box3D &domain_, [[maybe_unused]] std::string &data) const
{
    domain_ = domain;
}
...
void MultiBoxedReductiveDataProcessorGenerator3D::serialize(
    [[maybe_unused]] Box3D &domain_, [[maybe_unused]] std::string &data) const
{ }
