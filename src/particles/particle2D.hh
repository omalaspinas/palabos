...
template <typename T, template <typename U> class Descriptor>
bool Particle2D<T, Descriptor>::getVector(plint, Array<T, 2> &) const
{
    return false;
}

template <typename T, template <typename U> class Descriptor>
bool Particle2D<T, Descriptor>::setVector(plint, Array<T, 2> const &)
{
    return false;
}

template <typename T, template <typename U> class Descriptor>
bool Particle2D<T, Descriptor>::getScalar(plint, T &) const
{
    return false;
}

template <typename T, template <typename U> class Descriptor>
bool Particle2D<T, Descriptor>::setScalar(plint, T)
{
    return false;
}

template <typename T, template <typename U> class Descriptor>
bool Particle2D<T, Descriptor>::getTensor(plint, Array<T, SymmetricTensorImpl<T, 2>::n> &) const
{
    return false;
}

template <typename T, template <typename U> class Descriptor>
bool Particle2D<T, Descriptor>::setTensor(plint, Array<T, SymmetricTensorImpl<T, 2>::n> const &)
{
    return false;
}

template <typename T, template <typename U> class Descriptor>
bool Particle2D<T, Descriptor>::setScalars(std::vector<T> const &)
{
    return false;
}

template <typename T, template <typename U> class Descriptor>
bool Particle2D<T, Descriptor>::setVectors(std::vector<Array<T, 2> > const &)
{
    return false;
}
...
bool Particle2D<T, Descriptor>::setTensors(
    std::vector<Array<T, SymmetricTensorImpl<T, 2>::n> > const &)
{
    return false;
}
...
template <typename T, template <typename U> class Descriptor>
void RestParticle2D<T, Descriptor>::velocityToParticle(TensorField2D<T, 2> &, T)
{ }

template <typename T, template <typename U> class Descriptor>
void RestParticle2D<T, Descriptor>::velocityToParticle(NTensorField2D<T> &, T)
{ }

template <typename T, template <typename U> class Descriptor>
void RestParticle2D<T, Descriptor>::rhoBarJtoParticle(NTensorField2D<T> &, bool, T)
{ }

template <typename T, template <typename U> class Descriptor>
void RestParticle2D<T, Descriptor>::fluidToParticle(BlockLattice2D<T, Descriptor> &, T)
{ }
