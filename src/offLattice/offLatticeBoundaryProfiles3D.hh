...
template <typename T>
void NoSlipProfile3D<T>::setNormal(Array<T, 3> const &)
{ }

template <typename T>
void NoSlipProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }

template <typename T>
void NoSlipProfile3D<T>::getData(
    Array<T, 3> const &, plint, AtomicBlock3D const *, Array<T, 3> &data,
...
template <typename T>
void FreeSlipProfile3D<T>::setNormal(Array<T, 3> const &)
{ }

template <typename T>
void FreeSlipProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
void PoiseuilleProfile3D<T>::getData(
    Array<T, 3> const &pos, plint, AtomicBlock3D const *, Array<T, 3> &data,
    OffBoundary::Type &bdType) const
{
    bdType = OffBoundary::dirichlet;
...
void IncreasingPoiseuilleProfile3D<T, Descriptor>::getData(
    Array<T, 3> const &pos, plint, AtomicBlock3D const *argument, Array<T, 3> &data,
    OffBoundary::Type &bdType) const
{
    bdType = OffBoundary::dirichlet;
...
template <typename T, template <typename U> class Descriptor>
void IncreasingVelocityProfile3D<T, Descriptor>::setNormal(Array<T, 3> const &)
{ }

template <typename T, template <typename U> class Descriptor>
void IncreasingVelocityProfile3D<T, Descriptor>::defineCircularShape(Array<T, 3> const &, T)
{ }

template <typename T, template <typename U> class Descriptor>
void IncreasingVelocityProfile3D<T, Descriptor>::getData(
    Array<T, 3> const &, plint, AtomicBlock3D const *argument, Array<T, 3> &data,
    OffBoundary::Type &bdType) const
{
    bdType = OffBoundary::dirichlet;
    BlockLattice3D<T, Descriptor> const *lattice =
...
template <typename T, template <typename U> class Descriptor>
void IncreasingVelocityPlugProfile3D<T, Descriptor>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T, template <typename U> class Descriptor>
void TimeDependentVelocityProfile3D<T, Descriptor>::setNormal(Array<T, 3> const &)
{ }

template <typename T, template <typename U> class Descriptor>
void TimeDependentVelocityProfile3D<T, Descriptor>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T>
void ConstantVelocityProfile3D<T>::setNormal(Array<T, 3> const &)
{ }

template <typename T>
void ConstantVelocityProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T>
void VelocityPlugProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T>
void ExactRotationalVelocityProfile3D<T>::setNormal(Array<T, 3> const &)
{ }

template <typename T>
void ExactRotationalVelocityProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T>
void NeumannBoundaryProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T>
void DensityNeumannBoundaryProfile3D<T>::setNormal(Array<T, 3> const &)
{ }

template <typename T>
void DensityNeumannBoundaryProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T>
void ScalarDirichletProfile3D<T>::setNormal(Array<T, 3> const &)
{ }

template <typename T>
void ScalarDirichletProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }

template <typename T>
void ScalarDirichletProfile3D<T>::getData(
    Array<T, 3> const &, plint, AtomicBlock3D const *, Array<T, 2> &data,
    OffBoundary::Type &bdType) const
{
    bdType = OffBoundary::dirichlet;
    data[0] = value;
...
template <typename T>
void ScalarNeumannProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T>
void ScalarFluxProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
...
template <typename T>
void ScalarIsolationProfile3D<T>::defineCircularShape(Array<T, 3> const &, T)
{ }
