...
/// I/O
DataSerializer *MultiGrid3D::getBlockSerializer(Box3D const &, IndexOrdering::OrderingT) const
{
    PLB_ASSERT(false);
    return 0;
}

DataUnSerializer *MultiGrid3D::getBlockUnSerializer(Box3D const &, IndexOrdering::OrderingT)
{
    PLB_ASSERT(false);
    return 0;
}
